...
# NOTE: grouplens lnks are no longer working - dropbox URLs have been added instead
...
# new URLs given by course staff in Discussion post as original links aren't working!
